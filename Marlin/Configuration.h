...
#define STRING_CONFIG_H_AUTHOR "(Knobbe, CR-10mini EZABL BTT)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Mini BTT EZ -RO"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -64.5,-8, 0 }
